...
legend("topleft",c("Green Bay","WLE"),fill=c("white","grey80"),bty="n")
points(2,238,lwd=2,col="red",cex=1.5)
points(2,250,col="red",cex=2,pch=18)
points(MC*20~c(0.9,3.9,1.9,2.9),data=GB.NT[c(1,5,9,13),],cex=2,col="red",lwd=2,pch=18)
points(MC*20~c(1.1,4.1,2.1,3.1),data=Mau.NT[c(1,5,9,13),],col="red",lwd=2,pch=1,cex=1.5)
axis(4,las=2,labels=seq(0,10,by=2),at=seq(0,250,by=50),col="red",col.axis="red")
mtext("Microcystin (µg/L)",4,line=2.5,col="red",cex=1.5)
abline(h=0.1*60,col="red",lty=2)
rect(-1,225,2.3,300)
