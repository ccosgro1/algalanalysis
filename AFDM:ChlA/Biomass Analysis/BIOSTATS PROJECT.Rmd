...
summary(ford1$treatment)
###how do I get rid of initial and chelex labels.. they aren't treatments in ford1... 
```
#GREENBAY
```{r}
#AFDM MANOVA
...
plot(AFDM~treatment,data=greenbay1,
     main="Greenbay AFDM per Treatment",
     ylab="AFDM mg/L",
     xlab="", las=2)
```
##NORTH ERIE
...
plot(AFDM~treatment,data=nerie1,
     main="North Erie AFDM per Treatment",
     ylab="AFDM mg/L",
     xlab="", las=2)
```
##MAUMEE
...
plot(AFDM~treatment,data=maumee1,
     main="Maumee AFDM per Treatment",
     ylab="AFDM mg/L",
     xlab="", las=2)
```
